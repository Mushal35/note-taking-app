...
[View Demo](https://note-taking-app-chi-three.vercel.app) · [Report Bug](https://github.com/Mushal35/note-taking-app/issues) · [Request Feature](https://github.com/Mushal35/note-taking-app/issues)
...
```bash
git clone https://github.com/Mushal35/note-taking-app.git
cd notes-app
```
